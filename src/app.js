...
function renderGeneradores(docs) {
  ...
  const condIcon = { 'Óptimo':'<i class="ph-bold ph-check"></i>', 'Regular':'<i class="ph-bold ph-warning"></i>', 'Deficiente':'<i class="ph-bold ph-x"></i>', 'Fuera de Servicio':'<i class="ph-bold ph-prohibit"></i>' };
  const tipoColor = {
